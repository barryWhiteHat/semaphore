...
contract TestLongsightF
{
	...
	function testKnownF322 () public
	{
		uint256[322] memory round_constants;
		LongsightF.ConstantsF322p5(round_constants);

		uint256 x_L = 3703141493535563179657531719960160174296085208671919316200479060314459804651;
		uint256 x_R = 134551314051432487569247388144051420116740427803855572138106146683954151557;
		uint256 expected = 1955118202659622298192442035507501123132991419752400995882287708761535290053;

		uint256 result = LongsightF.LongsightF322p5(x_L, x_R, round_constants);
